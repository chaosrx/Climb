...
namespace SmartFirstPersonController
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        internal static void Jump()
        {
            ...
            if( instance.canJump && instance.canWalk && !instance.jump && !isJumping )
                instance.jump = true;
        }
        ...
        {
            float horizontal = SmartInputManager.moveHorizontal * Time.timeScale; // move Left/Right
            float vertical = SmartInputManager.moveVertical * Time.timeScale;     // move Forward/Backward
        ...
        {
            bool runReady = ( canRun && !isCrouched && inForward );
            isRunning = ( SmartInputManager.runAction && runReady );
        ...
        {
            rotationX += SmartInputManager.lookHorizontal * Time.timeScale;
            rotationY += SmartInputManager.lookVertical * Time.timeScale;
        ...
        {
            GameObject bAnimGO = instance.GetComponentInChildren<BodyAnimation>().gameObject;
            if( bAnimGO != null )
