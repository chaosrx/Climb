...
namespace SmartFirstPersonController.Inspector
{
    ...
    {
        private static string MAIN_DATABASE_PATH { get { return SFPCSettingsWindow.mainDirectory + "/SurfaceDetector.asset"; } }
        private static string TMP_DATABASE_PATH { get { return SFPCSettingsWindow.mainDirectory + "/tmp/SurfaceDetectorTMP.asset"; } }
        ...
        private static void ShowTab( ref SerializedProperty array, ref SerializedProperty element, float space )
        {
            ...
            for( int i = 0; i < materialsSize; i++ )
            {
                ...
                GUILayout.BeginHorizontal();
                bool mUp = SFPCSettingsWindow.NotBegin( i ) ? GUILayout.Button( "◄", GUILayout.Width( 22f ), GUILayout.Height( 20f ) ) : false;
                GUILayout.Space( SFPCSettingsWindow.NotBegin( i ) ? 47f : 76f );
                bool mDown = SFPCSettingsWindow.NotEnd( i, materialsSize ) ? GUILayout.Button( "►", GUILayout.Width( 22f ), GUILayout.Height( 20f ) ) : false;
                GUILayout.EndHorizontal();
                ...
                cells++;
                int maxCells = Mathf.RoundToInt( SFPCSettingsWindow.width / 170f );
